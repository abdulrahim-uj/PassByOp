...
<form id="form1" name="form1" method="post" action="">
  <table width="692" height="292" border="1" align="center">
    <tr>
    ...
    <% 
        ...
        ResultSet rs=st.executeQuery("SELECT * FROM files,`shares` WHERE files.`FID`=`shares`.`FID` AND `shares`.`RID`='"+lid+"'");
        int i=0;
        while(rs.next())
        {
            i++;
    ...
    <tr>
        ...
        <td><font color="blue"><img src="Photos/<%=rs.getString("FLNAME")%>" width="100" height="100" /></font></td>
